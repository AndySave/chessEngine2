...
#ifndef CHESSENGINE2_PIECETABLES_H
#define CHESSENGINE2_PIECETABLES_H
...
constexpr int pieceTables[12][64][2] = {
    {//Pawn
...
/// -----------------------------VALUES----------------------------- ///
inline int pieceTableScoreMG = 0;
inline int pieceTableScoreEG = 0;

/// -----------------------------GET/UPDATE FUNCTIONS----------------------------- ///
inline int getMirror(int sq){
    return mirror64[sq];
}
